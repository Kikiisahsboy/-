...
public class WxPayServiceImpl implements WxPayService {
    ...
    public WxPrepayVo createWxPayment(PaymentInfoForm paymentInfoForm) {
        try {
            ...
            amount.setTotal(paymentInfoForm.getAmount().multiply(new BigDecimal(100)).intValue());//单位为分，100=1元，实际为用户支付的费用
            ...
            //4 调用微信支付使方法（由于需要注册公司，此处直接默认支付成功）
