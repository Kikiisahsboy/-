...
public class OrderInfoController {
    ...
    public Result<PageVo> findCustomerOrderPage(@PathVariable Long customerId,
        ...
        //创建page对象
        Page<OrderInfo> pageParam = new Page<>(page,limit);//page limit:当前页 每页显示的数量
        //调用service方法实现分页条件查询
    ...
    public Result<Boolean> orderCancel(@PathVariable Long orderId){
        return Result.ok(orderInfoService.orderCancel(orderId));
    }
}
